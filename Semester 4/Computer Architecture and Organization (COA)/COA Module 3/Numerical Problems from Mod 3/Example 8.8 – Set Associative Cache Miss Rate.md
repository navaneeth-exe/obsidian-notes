...
222 Miss Rate=210Miss\ Rate = \frac{2}{10}Miss Rate=102​ Miss Rate=0.2=20%Miss\ Rate = 0.2 = 20\%Miss Rate=0.2=20%
...
This occurs because the **two-way set associative cache can store both addresses in the same set**, avoiding the conflict that occurred in the direct mapped cache.